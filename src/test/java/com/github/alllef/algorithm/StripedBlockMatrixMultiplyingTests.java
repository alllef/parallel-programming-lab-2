...
public class StripedBlockMatrixMultiplyingTests {
    StripedBlockMatrixMultiplying stripedBlockMatrixMultiplying = new StripedBlockMatrixMultiplying();

    @ParameterizedTest
    @MethodSource("matrProvider")
    void multiplyTest(int[][] firstMatr, int[][] secondMatr, int[][] expectedResultMatr) {
        int[][] actualResultMatr = stripedBlockMatrixMultiplying.multiply(firstMatr, secondMatr);
